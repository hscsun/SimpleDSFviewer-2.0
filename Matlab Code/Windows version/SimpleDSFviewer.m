...
%open and read raw data
 global a kk te n mtx mtxs ano val ab mttbar  smsorts smFDs maxsmresult norsorts norFDs mediposi medivalue cvname cvpath colorpicker t
...
%calculate the melting temperature of each well by decode the max FD into te 
 ...
 for v=1:96
   ...
   %  if (sorts(test)-medi)>medi*0.1 && (sorts(test)-medi)<value2*0.9
   %      test=test-1;
   %  end
     
     mediposi(v)=test;
     medivalue(v)=sorts(mediposi(v));
...
% handles    structure with handles and user data (see GUIDATA)
%open and read raw data
 global a kk te n mtx mtxs ano val ab mttbar smsorts smFDs maxsmresult norsorts  norFDs mediposi medivalue cvname cvpath colorpicker T1 t
 ...
 if mb==0
     ...
     if getsmooth==0    
         if isnormalise==0
            ...
            lig=[lig,[num2str(y),'=>Tms:',num2str(nums2),'; Condi:',num2str(condition2),'; Nosie:',num2str(noisy2),'; Tm:',num2str(te(locvs2(find(pkvs2==max(pkvs2)))))]];
     ...
     elseif getsmooth==2
        ...
        lig=[lig,[num2str(y),'=>Tms:',num2str(nums),'; Condi:',num2str(condition),'; Nosie:',num2str(noisy),'; Tm: ',num2str(te(locvs))]];
     elseif getsmooth==1
...
ylabel('Fluorescence (A.U.)','FontSize',14,'FontWeight','normal','Color','k');
xlabel('Temperature ( ^{\circ}C )','FontSize',14,'FontWeight','normal','Color','k');
 end
...
function pushbutton5_Callback(hObject, eventdata, handles)
 ...
 elseif getsmooth==1 || getsmooth==2
    ...
    ylabel('dFluorescence (A.U.)','FontSize',14,'FontWeight','normal','Color','k');
    xlabel('Temperature ( ^{\circ}C )','FontSize',14,'FontWeight','normal','Color','k');
...
% handles    structure with handles and user data (see GUIDATA)
 ...
 global PG1 PG2 PG3 PG4 PG5 PG6 PG7 PG8 PG9 PG10 PG11 PG12 PH1 PH2 PH3 PH4 PH5 PH6 PH7 PH8 PH9 PH10 PH11 PH12
    ...
    PG1=73; PG2=74; PG3=75; PG4=76; PG5=67; PG6=78; PG7=79; PG8=80; PG9=81; PG10=82; PG11=83; PG12=84;
...
% creat groups to compare
function controlANOVA_Callback(hObject, eventdata, handles)
 global  melting   biggest mttbar
 global groupss Strins  ab ano val
 global PA1 PA2 PA3 PA4 PA5 PA6 PA7 PA8 PA9 PA10 PA11 PA12 PB1 PB2 PB3 PB4 PB5 PB6 PB7 PB8 PB9 PB10 PB11 PB12
 global PC1 PC2 PC3 PC4 PC5 PC6 PC7 PC8 PC9 PC10 PC11 PC12 PD1 PD2 PD3 PD4 PD5 PD6 PD7 PD8 PD9 PD10 PD11 PD12
 global PE1 PE2 PE3 PE4 PE5 PE6 PE7 PE8 PE9 PE10 PE11 PE12 PF1 PF2 PF3 PF4 PF5 PF6 PF7 PF8 PF9 PF10 PF11 PF12
 global PG1 PG2 PG3 PG4 PG5 PG6 PG7 PG8 PG9 PG10 PG11 PG12 PH1 PH2 PH3 PH4 PH5 PH6 PH7 PH8 PH9 PH10 PH11 PH12
...
%mysize=[mysize,gsize(1,2)]
%mtxs{1,ab}=matrix;
%for pp=1:ab
    mttbar=[mttbar,mean(groupss)];
    bar(mttbar,'r');
    hold on
%end
end
...
function relativeeffect_Callback(hObject, eventdata, handles)
global ano val cvpath cvname
[p,a,s]=anova1(val,ano); 
p=anova1(val,ano); 
ylabel('Temperature ( ^{\circ}C )','FontSize',14,'FontWeight','normal','Color','k');
xlabel('Sample','FontSize',14,'FontWeight','normal','Color','k');
 
% savename=[cvpath, 'anaDSF\',cvname,'\MC'];
% print(mc,'-dpng','-r500',savename)
[c,m,h,nms] = multcompare(s);
%size(nms(c(:,1:6)))
%nms
%[nms(c(:,1)), nms(c(:,2)), num2cell(c(:,3:6))]
%figure;
%text(0.5,0.5,nms(c(:,1:6)))
ylabel('Temperature ( ^{\circ}C )','FontSize',14,'FontWeight','normal','Color','k');
xlabel('Sample','FontSize',14,'FontWeight','normal','Color','k');
set(gca,'FontSize',12)
...
%creat groups for melting temperature plot
function AddGroupANOVA_Callback(hObject, eventdata, handles)
 global  melting  mtx biggest mtc mtt er
 global groups Strin gStrin a mysize 
 global PA1 PA2 PA3 PA4 PA5 PA6 PA7 PA8 PA9 PA10 PA11 PA12 PB1 PB2 PB3 PB4 PB5 PB6 PB7 PB8 PB9 PB10 PB11 PB12
 global PC1 PC2 PC3 PC4 PC5 PC6 PC7 PC8 PC9 PC10 PC11 PC12 PD1 PD2 PD3 PD4 PD5 PD6 PD7 PD8 PD9 PD10 PD11 PD12
 global PE1 PE2 PE3 PE4 PE5 PE6 PE7 PE8 PE9 PE10 PE11 PE12 PF1 PF2 PF3 PF4 PF5 PF6 PF7 PF8 PF9 PF10 PF11 PF12
 global PG1 PG2 PG3 PG4 PG5 PG6 PG7 PG8 PG9 PG10 PG11 PG12 PH1 PH2 PH3 PH4 PH5 PH6 PH7 PH8 PH9 PH10 PH11 PH12
 melting=[PA1 PA2 PA3 PA4 PA5 PA6 PA7 PA8 PA9 PA10 PA11 PA12 PB1 PB2 PB3 PB4 PB5 PB6 PB7 PB8 PB9 PB10 PB11 PB12 PC1 PC2 PC3 PC4 PC5 PC6 PC7 PC8 PC9 PC10 PC11 PC12 PD1 PD2 PD3 PD4 PD5 PD6 PD7 PD8 PD9 PD10 PD11 PD12 PE1 PE2 PE3 PE4 PE5 PE6 PE7 PE8 PE9 PE10 PE11 PE12 PF1 PF2 PF3 PF4 PF5 PF6 PF7 PF8 PF9 PF10 PF11 PF12 PG1 PG2 PG3 PG4 PG5 PG6 PG7 PG8 PG9 PG10 PG11 PG12 PH1 PH2 PH3 PH4 PH5 PH6 PH7 PH8 PH9 PH10 PH11 PH12];
 cla reset;
 gStrin = str2num(get(handles.AddGroupsANOVA,'string'));
 axes(handles.axes1);
 msize=size(melting);
 mb=msize(1,2);
 %clear all.....important
...
% just a final run to get all, so mtc=[] is involved in this function to remove the history 
for pp=1:a
    mt=mtx{1,pp};
    mtcs=mean(mt(:,1));
    mtc=[mtc,mtcs];  
    ...
    e=std(mt(:,2));
    er=[er,e];
    errorbar(mtcs,mtts,e,'r*');
    hold on
end
end

%plot the melting temperature curve
function plotmeltingTm_Callback(hObject, eventdata, handles)

global mtc mtt er
[x,i]=sort(mtc);
y=mtt(i);
e=er(i);
pl=figure('Name','Melting Temperature against continue factors');
axes('FontSize',12);
errorbar(x,y,e,'m-');
hold on 
scatter(x,y,'r*','LineWidth',3);
plot(x,y,'color','b','LineWidth',2);
xlabel('Grediently Increasing','FontSize',14,'FontWeight','normal','Color','k');
ylabel('Melting Temperature ( ^{\circ}C )','FontSize',14,'FontWeight','normal','Color','k');
hold off
 savename=[cvpath, 'anaDSF\',cvname,'\MC'];
 print(pl,'-dpng','-r500',savename)
...
% --- Executes on button press in zerogroups.
function zerogroups_Callback(hObject, eventdata, handles)
% hObject    handle to zerogroups (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global  mygroups myStrin a mtx mtxs ab ano val mtc mtt er
mygroups=[];
myStrin=[];
mtx={};
 mtxs={};
...
global te sorts   colorpicker smsorts FDs  smFDs cvpath cvname
 global PA1 PA2 PA3 PA4 PA5 PA6 PA7 PA8 PA9 PA10 PA11 PA12 PB1 PB2 PB3 PB4 PB5 PB6 PB7 PB8 PB9 PB10 PB11 PB12
 global PC1 PC2 PC3 PC4 PC5 PC6 PC7 PC8 PC9 PC10 PC11 PC12 PD1 PD2 PD3 PD4 PD5 PD6 PD7 PD8 PD9 PD10 PD11 PD12
 global PE1 PE2 PE3 PE4 PE5 PE6 PE7 PE8 PE9 PE10 PE11 PE12 PF1 PF2 PF3 PF4 PF5 PF6 PF7 PF8 PF9 PF10 PF11 PF12
 global PG1 PG2 PG3 PG4 PG5 PG6 PG7 PG8 PG9 PG10 PG11 PG12 PH1 PH2 PH3 PH4 PH5 PH6 PH7 PH8 PH9 PH10 PH11 PH12
 ...
 if mb==0
     ...
     if getsmooth==0    
         if isnormalise==0
            plot(te,sorts(:,y),'color',co,'LineWidth',2);   
            lig=[lig,[num2str(y),'=>Tms:',num2str(nums2),'; Condi:',num2str(condition2),'; Tm:',num2str(te(locvs2(find(pkvs2==max(pkvs2)))))]];
         elseif isnormalise==1
            debg=sorts(:,y)-min(sorts(:,y));
            plot(te,(debg/max(debg)),'color',co,'LineWidth',2);    
            lig=[lig,[num2str(y),'=>Tms:',num2str(nums2),'; Condi:',num2str(condition2),'; Tm:',num2str(te(locvs2(find(pkvs2==max(pkvs2)))))]];    
     ...
     elseif getsmooth==2
        ...
        hold on
        plot(te,smsorts(:,y),'color','k','LineWidth',2); 
        lig=[lig,[num2str(y),'=>Tms:',num2str(nums),'; Condi:',num2str(condition),'; Tm: ',num2str(te(locvs))]];
     elseif getsmooth==1
        debg2=smsorts(:,y)-min(smsorts(:,y));
        plot(te,(debg2/max(debg2)),'color',co,'LineWidth',2);
        lig=[lig,[num2str(y),'=>Tms:',num2str(nums),'; Condi:',num2str(condition),'; Tm: ',num2str(te(locvs))]];
...
global te sorts FDs biggest maxsmresult norsorts norFDs mediposi
%[Rname Rpath] = uiputfile({'*.mat'},'save as');
...
xlswrite(str,{'Temperature','A1','A2','A3','A4','A5','A6','A7','A8','A9','A10','A11','A12',...
                             ...
                             'H1','H2','H3','H4','H5','H6','H7','H8','H9','H10','H11','H12',...
                             ''},'MCs and FDs','A1');
 xlswrite(str,xl,'MCs and FDs','A2');
 
 xlswrite(str,{'Well','Melting Temperature','Smoothed MT','Half Level MT'},'Tm','A1');
 xlswrite(str,names,'Tm','A2');
 xlswrite(str,xxl,'Tm','B2');
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global te sorts   colorpicker smsorts FDs  smFDs mediposi cvname cvpath
 global PA1 PA2 PA3 PA4 PA5 PA6 PA7 PA8 PA9 PA10 PA11 PA12 PB1 PB2 PB3 PB4 PB5 PB6 PB7 PB8 PB9 PB10 PB11 PB12
 global PC1 PC2 PC3 PC4 PC5 PC6 PC7 PC8 PC9 PC10 PC11 PC12 PD1 PD2 PD3 PD4 PD5 PD6 PD7 PD8 PD9 PD10 PD11 PD12
 global PE1 PE2 PE3 PE4 PE5 PE6 PE7 PE8 PE9 PE10 PE11 PE12 PF1 PF2 PF3 PF4 PF5 PF6 PF7 PF8 PF9 PF10 PF11 PF12
 global PG1 PG2 PG3 PG4 PG5 PG6 PG7 PG8 PG9 PG10 PG11 PG12 PH1 PH2 PH3 PH4 PH5 PH6 PH7 PH8 PH9 PH10 PH11 PH12
 ...
 if mb==0
     ...
     if isnormalise==0       
        plot(te,sorts(:,y),'color',co,'LineWidth',2);   
        lig=[lig,[num2str(y),'>Tm:',num2str(te(mediposi(y)))]];
     elseif isnormalise==1
        debg2=smsorts(:,y)-min(smsorts(:,y));
        plot(te,(debg2/max(debg2)),'color',co,'LineWidth',2);
        lig=[lig,[num2str(y),'>Tm:',num2str(te(mediposi(y)))]];
     ...
     hold on
        ...
        y=meltings(x);
            if y==97
                ...
                if isnormalise==0 
                plot(te(mediposi(y)),smsorts(mediposi(y),y),'k.','MarkerSize',24);
                elseif isnormalise==1
                plot(te(mediposi(y)),(smsorts(mediposi(y),y)-min(smsorts(:,y)))/(max(smsorts(:,y))-min(smsorts(:,y))),'k.','MarkerSize',24);                 
                end
            end   
        hold on
      ...
      if lege==1
        legend(lig,'Location','southeast','TextColor','b','FontWeight','bold');
      end
 end
ylabel('Fluorescence (A.U.)','FontSize',14,'FontWeight','normal','Color','k');
xlabel('Temperature ( ^{\circ}C )','FontSize',14,'FontWeight','normal','Color','k');
...
savename=[cvpath, 'anaDSF\',cvname,'\hMCMT'];
...
% handles    structure with handles and user data (see GUIDATA)
 [Rname Rpath] = uiputfile({'*.xlsx'},'save as');
 str = [Rpath Rname]; 
 global te sorts  FDs smsorts smFDs
 global PA1 PA2 PA3 PA4 PA5 PA6 PA7 PA8 PA9 PA10 PA11 PA12 PB1 PB2 PB3 PB4 PB5 PB6 PB7 PB8 PB9 PB10 PB11 PB12
 global PC1 PC2 PC3 PC4 PC5 PC6 PC7 PC8 PC9 PC10 PC11 PC12 PD1 PD2 PD3 PD4 PD5 PD6 PD7 PD8 PD9 PD10 PD11 PD12
 global PE1 PE2 PE3 PE4 PE5 PE6 PE7 PE8 PE9 PE10 PE11 PE12 PF1 PF2 PF3 PF4 PF5 PF6 PF7 PF8 PF9 PF10 PF11 PF12
 global PG1 PG2 PG3 PG4 PG5 PG6 PG7 PG8 PG9 PG10 PG11 PG12 PH1 PH2 PH3 PH4 PH5 PH6 PH7 PH8 PH9 PH10 PH11 PH12
 ...
 %a=['Temperature',selename] is not equal to {...}
 seledata2=FDs(:,sel);
 SeleFDs(:,1)=te;
 SeleFDs(:,2:(length(sel)+1))=seledata2;
 xlswrite(str,['Temperature',selename],'First derivatives','A1');
 xlswrite(str,SeleFDs,'First derivatives','A2');
 
 seledata3=smsorts(:,sel);
 SeleNorMCs(:,1)=te;
 ...
 save('SelectedWells.mat','SeleMCs','SeleFDs','SeleNorMCs','SeleNorFDs','wellname')
